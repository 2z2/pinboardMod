	...
	<div class="entry">
		...
		<div class="entry-container">
			<header class="entry-header">
				<<?php pinboard_title_tag( 'post' ); ?> class="entry-title"><a href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title(); ?>"><?php echo get_post_meta($post->ID, 'short_title', true); ?></a></<?php pinboard_title_tag( 'post' ); ?>>
				<?php if( pinboard_post_is_full_width() ) : ?>
